...
% Generates the List of Publications. The argument should point to
% the file containing your List of Publications.
%\thesispublications{SupplementaryMaterial/Publications}
