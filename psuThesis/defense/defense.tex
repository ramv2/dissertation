...
\begin{document}
	...
	\subsection{Path Integral Monte Carlo}
        ...
        \begin{frame}
            ...
            \begin{itemize}
                ...
                \item Straightforward but non-trivial extension to multiatomic systems.
            \end{itemize}
        \end{frame}
        \begin{frame}
            \frametitle{Orientation sampling}
        ...
        \begin{frame}
            ...
            \begin{itemize}
                \begin{columns}[c]
                    \column{6cm}
                    \item Angle between image 0 and image P is 0 for Boltzmann type and $\pi$ for exchange type conformations. The choice of orientation of image 0 is arbitrary
        ...
        \begin{frame}
            ...
            \begin{itemize}
                ...
                \end{equation*}
                where $n$ and $J$ are rotational and vibrational quantum numbers respectively, while $\chi_{nJ}$ denotes the corresponding wave-function.
                \begin{equation*}
	...
	\section{Results}
        ...
        \subsection{Hydrogen}
            \begin{frame}
                \frametitle{Bond length\putCitation{Garberoglio2014}- $< r >_0$ - 10$^7$ configuration samples total}
                \begin{figure}
                    \centering
            ...
            \end{frame}
            \begin{frame}
                \frametitle{Bond length\putCitation{Garberoglio2014}- $< r >_T$ - 10$^7$ configuration samples total}
                \begin{figure}
                    \centering
            ...
            \end{frame}
            \begin{frame}
                \frametitle{Bond length\putCitation{Garberoglio2014}- flexible bond-length - 10$^7$ configuration samples total}
                \begin{figure}
                    \centering
            ...
            \end{frame}
        \begin{frame}
            \frametitle{Bond length\putCitation{Garberoglio2014}- $< r >_0$}
            \begin{figure}
                \centering
                \includegraphics[scale=0.18,keepaspectratio]{s1GarberoglioAll.png}
            \end{figure}
