...
\begin{document}
    ...
    \subsection{\Abinitio{} potentials}
        ...
        \begin{frame}
            \frametitle{Nuclear quantum effects}
            \begin{itemize}
                \item Importance of nuclear quantum effects for $^4$He\putCitation{Shaul2012}
            \end{itemize}
            \begin{figure}
            \centering
	...
	\subsection{Path Integral Monte Carlo}
        ...
        \end{frame}
        \begin{frame}
            \frametitle{Orientation sampling - bisection algorithm for Boltzmann type conformations}
            \begin{itemize}
                \begin{columns}[c]
                    \column{6cm}
